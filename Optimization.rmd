...
library(optimx) #for multidimensional optimization
...
The `optimize()` function is also used for one dimensional problems. Its first argument is the function to be optimized and the second argument is the solution search space as provided by the user. It may only be used to detect local extrema.
