...
\NormalTok{x_}\DecValTok{1}\NormalTok{ <-}\StringTok{ }\NormalTok{x_}\DecValTok{2}\NormalTok{ <-}\StringTok{ }\KeywordTok{seq}\NormalTok{(}\FloatTok{0.1}\NormalTok{, }\FloatTok{0.9}\NormalTok{, }\FloatTok{0.05}\NormalTok{)}
...
\hypertarget{ref-Simon_and_Blume:1994}{}
Simon, Carl, and Lawrence Blume. 1994. \emph{Mathematics for
Economists}. W W Norton.
