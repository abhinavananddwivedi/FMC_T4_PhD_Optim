...
conditional dependence. Median regression computations for large data
sets are quite tedious compared to the least squares method leading to
its unpopularity until recent advances in cheap computation.
