...
If the curves are tangents to each other at the optimal point then it must be so that the tangents to the curves at the optimal are in the same direction---either coinciding or parallel to each other.
...
In order for the slopes to be well-defined, $\frac{\partial h}{\partial x_1}(x^*)\neq 0$ or $\frac{\partial f}{\partial x_2}(x^*)\neq 0$, or both not equal to 0. Since this is a restriction on the constraint set, it's called a *constraint qualification*.
