...
The expression $[\frac{\partial f}{\partial x_1}(x),\hdots,\frac{\partial f}{\partial x_n}(x)]$ is the generalization of the idea of a derivative of a real valued function to $n$ dimensions. It's denoted as a column vector and hence the expression above can be re-written as:
